...
const ListOfProjectsSection= () => {
    const classNamesNav = 'n.navbarToggler n.ololo';
    const classNamesInput = 'n.searchBar n.searchAddCurator';
    return(
        <section className="main-menu">
            <div className={n.containerMenu}>
                <div className="searching">
                    <div className={n.searchBar}>
                        <button className={classNamesNav} type="button" data-bs-toggle="collapse"
